                                ...
                                <div className='grid grid-cols-2 gap-10 pr-[5rem] pl-[5rem] '>
                                     ...
                                     <div className='flex flex-col items-right justify-center'>
                                        ...
                                        <div className='text-right space-y-6'>
                                            <motion.img variants={SlideRight(0.9)} initial="hidden" whileInView="visible" viewport={{once : false}} className='h-full object-cover drop-shadow-2xl' src="/imgi_2_2-D6fIL54y.png" alt="" />
                                        </div>
                                    ...
                                    <div className='flex flex-col py-14 justify-center' style={{ fontFamily: "'Playfair Display', serif" }}>
                                        ...
                                        <div className='text-left space-y-4'>
                                            ...
                                            <motion.div variants={SlideLeft(0.9)} initial="hidden" whileInView="visible" viewport={{once : false}}v className='flex flex-row gap-5'>
